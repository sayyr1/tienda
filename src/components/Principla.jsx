...
const Principla = () => {
  return (
    <div className='bg-white flex flex-col items-center justify-center landing md:px-60 md:w-auto md:h-auto'>
      ...
      <Link className='py-6 px-10 bg-yellow-500 rounded-full hover:bg-yellow-300 flex
            items-center transition duration-300 ease-in-out animate-bounce' to='/menu'>
        Ofertas
